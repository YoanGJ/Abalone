...
public class AbaloneBoard extends Pane {
	...
	private Cell[][] board = {
		...
		{new Cell(0, 3, 0), new Cell(0, 3, 1), new Cell(0, 3, 2), new Cell(0, 3, 3), new Cell(0, 3, 4), new Cell(0, 3, 5), new Cell(0, 3, 6), new Cell(0, 3, 7), new Cell(-1, 3, 8)},
		{new Cell(0, 4, 0), new Cell(0, 4, 1), new Cell(0, 4, 2), new Cell(0, 4, 3), new Cell(0, 4, 4), new Cell(0, 4, 5), new Cell(0, 4, 6), new Cell(0, 4, 7), new Cell(0, 4, 8), new Cell(-1, 4, 9)},
		{new Cell(0, 5, 0), new Cell(0, 5, 1), new Cell(0, 5, 2), new Cell(0, 5, 3), new Cell(0, 5, 4), new Cell(0, 5, 5), new Cell(0, 5, 5), new Cell(0, 5, 7), new Cell(-1, 5, 8)},
